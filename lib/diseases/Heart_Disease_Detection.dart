    ...
    return BlocProvider(
      ...
      child: BlocConsumer<AppCubit, AppStates>(
        ...
        builder: (context, state) {
          ...
          return Scaffold(
              appBar: AppBar(
                title: Text(S.of(context).Heart_Disease_Detection),
                centerTitle: true,
                    ...
                    child: Column(
                      children: [
                        Padding(
                          ...
                          child: builduttomUpload(context, index: 3),
                        ),
                        someInstructionBuilder(context),
                        DataOfDiseases(
                          context,
                          isShowMore: cubit.showMoreMap[0] ?? false,
                          nameDisease: isArabic() ? heartDataAr : heartDataEn,
                          index: 0,
                          icon: cubit.icon,
                        ...
                        DataOfDiseases(context,
                          ...
                          cubit.showMore(
                            ...
                            index: 1,
                            nameDisease:
                                isArabic() ? heartDataAr : heartDataEn),
                        SizedBox(
                          height: 20,
                        ),
                        DataOfDiseases(context,
